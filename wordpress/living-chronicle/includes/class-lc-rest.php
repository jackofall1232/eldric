...
final class LC_REST {
    public function __construct( private LC_Story_Controller $controller, private string $provider_id = 'local' ) {}
    ...
    public function health(): WP_REST_Response { $response = new WP_REST_Response( array( 'ok' => true, 'schema_version' => 1, 'provider' => $this->provider_id ), 200 ); $response->header( 'Cache-Control', 'no-store' ); return $response; }
}
